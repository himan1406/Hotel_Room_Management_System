...
def _role_specific_instructions(role: str | None) -> str:
    ...
    instructions = {
        ...
        "hotel_rep": (
            ...
            "3. Use PROPERTY_SEARCH when the user asks to find or browse "
            "properties by location, type, or rating.\n"
            "4. Use REP_AVAILABILITY_TODAY for questions about "
            "'room availability', 'rooms available today', 'how many rooms'.\n"
            "5. Use REP_BOOKINGS for questions about "
            "'my bookings', 'recent bookings', 'booking revenue', "
            "'how many bookings'.\n"
            "6. Use REP_REVIEWS for questions about "
            "'my reviews', 'guest feedback', 'review summary', "
            "'unanswered reviews'.\n"
            "7. Use REP_DOCUMENTS for questions about "
            "'my documents', 'uploaded policies', 'my uploaded files'.\n"
            "8. Use VECTOR_SEARCH for policy or amenity questions scoped "
            "to your own properties.\n"
            "9. Use REP_REVENUE_ANALYTICS to analyze revenue and booking statistics for a date range.\n"
            "10. Use MUTATION_REPLY_TO_REVIEW to reply to guest reviews.\n"
            "11. Use MUTATION_UPDATE_PROPERTY to update property details like description.\n"
            "12. You CANNOT access other reps' data or modify platform settings."
        ),
        "admin": (
            "1. You can view ALL platform data.\n"
            "2. Use PROPERTY_SEARCH for finding or browsing properties "
            "by location, type, or rating across the entire platform.\n"
            "3. Use VECTOR_SEARCH for policy or document questions across "
            "any property.\n"
            "4. Use ADMIN_STATISTICS for platform-wide stats like "
            "'total properties', 'total rooms', 'how many users'.\n"
            "5. Use ADMIN_PENDING_REGISTRATIONS for questions about "
            "'pending registrations', 'pending hotels', or 'approvals'.\n"
            "6. Use ADMIN_REP_LIST for questions about "
            "'hotel reps', 'list representatives', or to find a rep's UUID.\n"
            "7. Use MUTATION_APPROVE_HOTEL to approve a pending registration.\n"
            "8. Use MUTATION_REJECT_HOTEL to reject a pending registration.\n"
            "9. Use MUTATION_ACTIVATE_REP to reactivate a deactivated rep.\n"
            "10. Use MUTATION_DEACTIVATE_REP to deactivate an active rep.\n"
            "11. All mutation tools REQUIRE user confirmation. The Answer "
            "Generator should ask the user to confirm before proceeding.\n"
            "12. For pending registrations, mention them with details so the "
