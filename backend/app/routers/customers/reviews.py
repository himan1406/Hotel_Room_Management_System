...
from app.models.db_models import Booking, BookingStatus, Property, Review, User, UserRole
from app.routers.auth.auth import get_current_user, require_role, hash_token
from app.models.schemas import ReviewCreate, ReviewUpdate, ReviewRespond, ReviewResponse
from app.models.db_models import Session as SessionModel
from app.services.generate_highlights import update_property_highlight
