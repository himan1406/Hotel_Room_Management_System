...
from app.models.db_models import Property, Room, User, UserRole, Location, LocationType, Booking, BookingStatus, Availability, PropertyDocument, DocumentChunk, DocType
from app.routers.auth.auth import get_current_user, require_role
from app.routers.communication.rag import _chunk_text
from app.models.schemas import PropertyCreate, PropertyResponse, RoomCreate, RoomResponse
from app.core.extract_text import extract_text_from_bytes
...
def search_locations(
    ...
    from app.models.db_models import Property as PropertyModel
